...
export const ShippingPolicyPreview: React.FC = () => {
  ...
  const embedScript = userId
    ? `<!-- Step 1: place this where you want the Shipping Policy to appear -->\n<div id="uterms-shipping-policy"></div>\n\n<!-- Step 2: add this script tag (e.g. before </body>) -->\n<script src="http://localhost:3001/uterms-shipping-embed.js?id=${userId}"></script>`
    : '';
  ...
  if (!policy) {
    return (
      <div className="preview-loading">
        ...
        <button className="preview-back-btn" onClick={() => navigate('/shipping-policy')}>
    ...
    <div className="preview-container">
      <div className="preview-topbar">
        ...
        <div className="preview-actions">
          ...
          <button className="preview-btn" onClick={() => navigate(`/shipping-policy/${id}/edit`)}>
            <Pencil size={15} /> Edit
          </button>
          <button
      ...
      <div className="embed-section">
        ...
        {policy.status !== 'published' ? (
          <p className="embed-notice">Publish this Shipping Policy first to get the embed snippet.</p>
        ) : (
          <>
            <p className="embed-description">
              Paste the snippet below into any page to display your Shipping Policy. Place the{' '}
            ...
            <div style={{ display: 'flex' }}>
              <button
                ...
                onClick={() => window.open(`/test-shipping.html?id=${userId}`, '_blank')}
              >
