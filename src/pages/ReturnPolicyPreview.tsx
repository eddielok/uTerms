...
export const ReturnPolicyPreview: React.FC = () => {
  ...
  const embedScript = userId
    ? `<!-- Step 1: place this where you want the Return Policy to appear -->\n<div id="uterms-return-policy"></div>\n\n<!-- Step 2: add this script tag (e.g. before </body>) -->\n<script src="http://localhost:3001/uterms-return-policy-embed.js?id=${userId}"></script>`
    : '';
  ...
  if (!policy) {
    return (
      <div className="preview-loading">
        ...
        <button className="preview-back-btn" onClick={() => navigate('/return-policy')}>
    ...
    <div className="preview-container">
      <div className="preview-topbar">
        ...
        <div className="preview-actions">
          ...
          <button className="preview-btn" onClick={() => navigate(`/return-policy/${id}/edit`)}>
            <Pencil size={15} /> Edit
          </button>
          <button
      ...
      <div className="embed-section">
        ...
        {policy.status !== 'published' ? (
          <p className="embed-notice">Publish this Return Policy first to get the embed snippet.</p>
        ) : (
          <>
            <p className="embed-description">
              Paste the snippet below into any page to display your Return Policy. Place the{' '}
            ...
            <div style={{ display: 'flex' }}>
              <button
                ...
                onClick={() => window.open(`/test-return-policy.html?id=${userId}`, '_blank')}
              >
