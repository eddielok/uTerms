...
export const AccessibilityPreview: React.FC = () => {
  ...
  const embedScript = userId
    ? `<!-- Step 1: place this where you want the Accessibility Statement to appear -->\n<div id="uterms-accessibility"></div>\n\n<!-- Step 2: add this script tag (e.g. before </body>) -->\n<script src="http://localhost:3001/uterms-accessibility-embed.js?id=${userId}"></script>`
    : '';
  ...
  if (isLoading) return <div className="preview-loading">Loading policy...</div>;

  if (!policy) {
    return (
      <div className="preview-loading">
        <p>Policy not found.</p>
        <button className="preview-back-btn" onClick={() => navigate('/accessibility-statement')}>
    ...
    <div className="preview-container">
      <div className="preview-topbar">
        ...
        <div className="preview-actions">
          ...
          <button className="preview-btn" onClick={() => navigate(`/accessibility-statement/${id}/edit`)}>
            <Pencil size={15} /> Edit
          </button>
          <button
      ...
      <div className="preview-meta">
        ...
        <p className="preview-updated">
          Last updated: {new Date(policy.updated_at).toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}
        </p>
      </div>
      ...
      <div className="embed-section">
        ...
        {policy.status !== 'published' ? (
          <p className="embed-notice">Publish this Accessibility Statement first to get the embed snippet.</p>
        ) : (
          <>
            <p className="embed-description">
              Paste the snippet below into any page to display your Accessibility Statement. Place the{' '}
            ...
            <div style={{ display: 'flex' }}>
              <button
                ...
                onClick={() => window.open(`/test-accessibility.html?id=${userId}`, '_blank')}
              >
