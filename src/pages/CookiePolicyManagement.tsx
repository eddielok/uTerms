...
export const CookiePolicyManagement: React.FC = () => {
  ...
  const handleDelete = async (id: string) => {
    ...
    setDeletingId(id);
    await supabase.from('cookie_policies').delete().eq('id', id);
      ...
      <div className="pm-header">
        <div>
          ...
          <p className="pm-description">
            Generate and manage your cookie policies using our step-by-step wizard.
          </p>
        </div>
      </div>
      ...
      <div className="pm-table-wrapper">
        {isLoading ? (
                  ...
                  <td>
                    <div className="pm-actions">
                      <button
                        ...
                        title="Preview"
                        onClick={() => navigate(`/cookie-policy/${policy.id}/preview`)}
                      >
                        <Eye size={15} />
                      </button>
                      <button
                        className="pm-btn-icon"
                        title="Edit"
                        onClick={() => navigate(`/cookie-policy/${policy.id}/edit`)}
                      >
                        <Pencil size={15} />
                      </button>
                      <button
          ...
          <div className="pm-empty">
            ...
            <p>No cookie policies yet.</p>
            <p className="pm-empty-sub">
              Use our step-by-step wizard to create your first cookie policy.
            </p>
            <button
              className="btn-create"
              onClick={() => navigate('/cookie-policy/new')}
            >
