...
export const PolicyManagement: React.FC = () => {
  ...
  const handleDelete = async (id: string) => {
    ...
    setDeletingId(id);
    await supabase.from("privacy_policies").delete().eq("id", id);
      ...
      <div className="pm-header">
        <div>
          ...
          <p className="pm-description">
            Generate and manage your privacy policies using our step-by-step
            wizard.
          </p>
        </div>
      </div>
        ...
        {isLoading ? (
                  ...
                  <td>
                    <div className="pm-actions">
                      <button
                        ...
                        title="Preview"
                        onClick={() =>
                          navigate(`/policy-management/${policy.id}/preview`)
                        }
                      >
                        <Eye size={15} />
                      </button>
          ...
          <div className="pm-empty">
            ...
            <p className="pm-empty-sub">
              Use our step-by-step wizard to create your first privacy policy.
            </p>
            <button
              className="btn-create"
              onClick={() => navigate("/policy-management/new")}
            >
