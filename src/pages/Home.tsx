import { Activity, ArrowRight, CheckCircle2, Globe, Lock, ShieldCheck } from 'lucide-react';
        ...
        <div className="container hero-container">
          <div className="hero-content">
            <div className="badge-pill mb-6 inline-flex">
              ...
              New: AI-Powered Consent Classification
            </div>
            <h1 className="hero-title">
              Data Privacy Built for the <span className="text-gradient">Enterprise</span>
            </h1>
            <p className="hero-subtitle">
              Automate compliance, manage consent globally, and build trust with your users. 
              The all-in-one privacy platform that scales with your business.
            </p>
            ...
            <div className="glass-panel dashboard-preview">
              ...
              <div className="preview-body">
                ...
                <div className="chart-placeholder">
                  ...
                  <div className="chart-bar" style={{height: '100%', backgroundColor: 'var(--color-primary)'}}></div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="features-section">
        <div className="container">
          <div className="text-center mb-16">
            <h2 className="section-title">Everything you need for complete compliance</h2>
            <p className="section-subtitle">
              From cookie consent to data subject requests, we provide the tools to navigate complex privacy laws like GDPR, CCPA, and CPRA.
            </p>
          </div>
          ...
          <div className="features-grid">
            <Card className="feature-card">
              <CardContent className="flex flex-col gap-4 h-full pt-6">
                ...
                <p className="text-muted flex-grow">
                  Automatically detect visitors' locations and serve the legally required consent banner and languages.
                </p>
            ...
            <Card className="feature-card">
              <CardContent className="flex flex-col gap-4 h-full pt-6">
                <div className="feature-icon-wrapper bg-success/10 text-success" style={{ backgroundColor: 'rgba(16, 185, 129, 0.1)', color: '#10b981' }}>
                  <ShieldCheck size={28} />
                </div>
                <h3 className="text-xl font-bold">Policy Documentation</h3>
                <p className="text-muted flex-grow">
                  Generate, host, and automatically update your privacy policies, terms of service, and cookie notices.
                </p>
                <div className="feature-link group">
                  Learn more <ArrowRight size={16} className="transition-transform group-hover:translate-x-1" />
                </div>
            ...
            <Card className="feature-card">
              <CardContent className="flex flex-col gap-4 h-full pt-6">
                <div className="feature-icon-wrapper bg-warning/10 text-warning" style={{ backgroundColor: 'rgba(245, 158, 11, 0.1)', color: '#f59e0b' }}>
                  <Activity size={28} />
                </div>
                <h3 className="text-xl font-bold">Privacy Monitoring</h3>
                <p className="text-muted flex-grow">
                  Continuously scan your website for unclassified cookies and third-party trackers with real-time alerting.
                </p>
                <div className="feature-link group">
                  Learn more <ArrowRight size={16} className="transition-transform group-hover:translate-x-1" />
                </div>
          ...
          <div className="cta-box glass-panel">
            <div className="cta-content">
              ...
              <ul className="cta-benefits">
                ...
                <li><CheckCircle2 size={20} className="text-success" /> 24/7 dedicated support</li>
              </ul>
